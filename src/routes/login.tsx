      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2 animate-fade-in-down duration-700">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl font-extrabold tracking-tight text-white flex items-center justify-center gap-2">
              Pay<span className="bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent">Flow</span>
              <Sparkles className="h-4 w-4 text-emerald-400 animate-pulse" />
            </h1>
            <p className="text-sm text-slate-400">
              Sistem Penggajian Karyawan Multi-Cabang
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-900/70 border border-slate-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl relative overflow-hidden group">
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-400 mt-1">Silakan masuk menggunakan kredensial administrator Anda.</p>
          </div>
          ...
          <div className="mt-6 pt-5 border-t border-slate-800/60 text-center">
            <span className="text-[11px] text-slate-500">
              Hak Cipta &copy; {new Date().getFullYear()} PayFlow Premium. Seluruh hak cipta dilindungi.
            </span>
          </div>
        </div>
      </div>
